    ...
    if( isset($_POST["loginUser"]) &&  isset($_POST["senhaUser"])  ){
        ...
        if( $linha != 0 ) {
            ...
            $msg_error = "<div class='alert alert-danger mt-3'>
                            <p><b>Usuário não encontrado ou senha incorreta.</b></p>
                            </div>
            ";
        }
    }
                ...
                <form class="needs-validation" action="login.php" method="post" novalidate>
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" type="text" name="loginUser" id="loginUser" required autofocus>
                    ...
                    <button title="Iniciar Sessão" class="btn btn-success w-100"><i class="bi bi-box-arrow-in-right"></i> Entrar</button>
                </form>
            </div>
        </div>
    </div>
