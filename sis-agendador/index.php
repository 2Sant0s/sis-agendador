        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <a href="#" class="navbar-brand">
                    <img src="./img/logo_agendador.png" alt="sis-Agendador" width="200">
                </a>

                <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item"><a title="Página Principal" href="index.php?menuop=home" class="nav-link active">Home</a></li>
                        <li class="nav-item"><a a title="Página de Contatos" href="index.php?menuop=contatos" class="nav-link">Contato</a></li>
                        <li class="nav-item"><a a title="Página de Tarefas" href="index.php?menuop=tarefas" class="nav-link">Tarefas</a></li>
                        <li class="nav-item"><a a title="Página de Eventos" href="index.php?menuop=eventos" class="nav-link">Eventos</a></li>
                    </ul>
                    <div class="navbar-nav w-100 justify-content-end">
                        <a title="Encerrar Sessão" href="logout.php" class="nav-link">
...
?>
    ...
    <footer class="container-fluid bg-dark text-light fixed-bottom p-2">
        <div class="text-center"><strong>SIS Agendador V1.0</strong></div>
    </footer>
